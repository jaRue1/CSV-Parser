...
db.connect((err) => {
  ...
  query =
    "CREATE TABLE USERS (user_id INT, first_name VARCHAR(255), last_name VARCHAR(255), " +
  ...
  query =
    "LOAD DATA LOCAL INFILE 'csv/animeGenreTable.csv' INTO TABLE ANIME_GENRE FIELDS TERMINATED BY ','" +
  ...
  query =
    "LOAD DATA LOCAL INFILE 'csv/userReviewTable.csv' INTO TABLE USER_REVIEW FIELDS TERMINATED BY ',' IGNORE 1 LINES " +
    "(user_id, review)"
